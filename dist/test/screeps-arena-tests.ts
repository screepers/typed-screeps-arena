...
import {
  Flag,
} from "arena/season_alpha/capture_the_flag/basic/prototypes";
import {
  ScoreCollector,
  AreaEffect,
} from "arena/season_alpha/collect_and_control/basic/prototypes";
import {
  EFFECT_DAMAGE,
  EFFECT_FREEZE,
  RESOURCE_SCORE,
} from "arena/season_alpha/collect_and_control/basic/constants";
import {
  RESOURCE_SCORE_X,
  RESOURCE_SCORE_Y,
  RESOURCE_SCORE_Z,
